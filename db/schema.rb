...
ActiveRecord::Schema[7.0].define(version: 2023_07_05_150725) do
  ...
  create_table "stock_accounts", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_stock_accounts_on_user_id"
  end
  ...
  create_table "team_accounts", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_team_accounts_on_user_id"
  end
  ...
  create_table "wallets", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["entity_id", "entity_type"], name: "index_wallets_on_entity_id_and_entity_type", unique: true
